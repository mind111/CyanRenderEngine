...
namespace Cyan
{
    ...
    struct ILightRenderable
    {
        ...
        virtual void renderShadow(const Scene& scene, RenderableScene& renderableScene, Renderer& renderer) { }
    ...
    */
    struct DirectionalLightRenderable : public ILightRenderable
    {
        ...
        virtual void renderShadow(const Scene& scene, RenderableScene& renderableScene, Renderer& renderer) override;
