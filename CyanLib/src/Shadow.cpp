...
namespace Cyan
{
    ...
    void DirectionalShadowMap::render(const BoundingBox3D& lightSpaceAABB, Scene* inScene, Renderer* renderer) 
    {
        ...
        SceneView sceneView(inScene, &lightCamera, depthTexture.get());
