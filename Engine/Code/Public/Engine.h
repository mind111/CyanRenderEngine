...
namespace Cyan 
{
#define ENGINE_ASSET_PATH "C:/dev/cyanRenderEngine/Engine/Resources/"
    ...
    public:
        ...
        void addSceneRenderingTask(const SceneRenderingStage& sceneRenderingStage, const char* taskName, std::function<void(SceneView& view)>&& taskLambda);
    private:
