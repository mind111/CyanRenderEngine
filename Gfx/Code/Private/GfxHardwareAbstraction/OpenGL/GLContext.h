...
namespace Cyan
{
    ...
    public:
        ...
        virtual GHShader* createGeometryShader(const std::string& text) override;
        ...
        virtual GHGeometryPipeline* createGeometryPipeline(std::shared_ptr<GHShader> vs, std::shared_ptr<GHShader> gs, std::shared_ptr<GHShader> ps) override;
        // framebuffers
        ...
        virtual std::unique_ptr<GHTexture3D> createTexture3D(const GHTexture3D::Desc& desc, const GHSampler3D& sampler3D = GHSampler3D()) override;
        virtual std::unique_ptr<GHRWBuffer> createRWBuffer(u32 sizeInBytes) override;
        virtual std::unique_ptr<GHAtomicCounterBuffer> createAtomicCounterBuffer() override;
        // static mesh
